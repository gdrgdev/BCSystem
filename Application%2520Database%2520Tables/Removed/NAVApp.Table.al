...
table 2000000160 "NAV App"
{
    ...
    ObsoleteReason = 'This table is deprecated in favour of the "Published Application" table.';
    ...
    fields
    {
        ...
        field(33; "Package Hash"; Text[64])
        {
            Caption = 'Package Hash';
        }
        field(34; "Application Insights Key"; Guid)
        {
